...
import { setAllCategories, setUserID, setUsername, setUserPic, setUserLikedPost } from '../../../redux/actions'
...
const AllPostsPhone = ({phone}) => {
    ...
    const {allCategories,category,username} = useSelector(state=>state.userReducer)
    ...
    <Container>
      ...
      <Header>
          ...
          <div style={{display:'flex', alignItems:'center', gap:15}}>
            <IoMdAdd 
                onClick={addPost}
                style={{padding:15, borderRadius:5, background:'#ff7f50', color:'white',cursor:'pointer',}}
            />
            <PhoneDropDown 
