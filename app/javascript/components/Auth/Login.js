...
const Login = ({phone}) => {
  ...
  return (
    <Container>
        ...
        <Wrapper phone={phone}>
            <span style={{fontFamily:'Poppins', fontSize:'1.2rem', fontWeight:600, padding:5}}>Welcome Back</span>
            <span style={{color:'gray', fontWeight:300, fontFamily:'Poppins', fontSize:'0.8rem'}}>Enter your credentials to access your account</span>
            <form onSubmit={handleSubmit} style={{width:'100%'}}>
            <InputField>
                <input type='text'  name='username' placeholder='Username'  onChange={e=>(setTemporaryUsername(e.target.value))} />
            </InputField>
            <InputField>
